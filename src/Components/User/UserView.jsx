...
<h4 style={{marginLeft:'25px',marginTop:'15px',fontSize:'14px', fontWeight:'600',letterSpacing:'0px'}} className="generate-number" >{`TN0001${data.SerialNo}`}</h4>
        </div>
        {data.dispatchNo && (
      ...
      <table style={{marginTop:'-3px'}} className="query-table">
        <tbody className="table-body">
          <tr>
            ...
            <td style={{width:'130px'}}>Serial No: <span className='serial' style={{letterSpacing:'1px',fontSize:'9px'}}>{`TN0001${data.SerialNo}`}</span></td>
          </tr>
          <tr>
